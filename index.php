...
<html>
	...
	<body>
		...
		<section id="about">
			<div class="container">
				<h3>About</h3>
				<p>Saya Novi Alviansyah ,berumur 22 Tahun. Saat ini saya sedang menjalankan pendidikan di Universitas Potensi Utama </p>
		...
		<section id="contact">
			<div class="container">
				...
				<div class="col-3">
					<h4>Alamat</h4>
					<p>Bagan Deli,Lorong V Veteran</p>
				</div>

				<div class="col-3">
					<h4>Email</h4>
					<p>Novialviasyah@gmail.com</p>
				</div>
